...
<section class="imgslider">
  ...
  <div class="products">
    <div class="product-card">
      <img src="${contextPath}/resources/images/1.avif" alt="Dell 16 Plus Laptop">
    ...
    <div class="product-card">
      <img src="${contextPath}/resources/images/3.png" alt="Dell Latitude 14 3440">
    ...
    <div class="product-card">
      <img src="${contextPath}/resources/images/4.png" alt="Dell Inspiron 14 5445">
    ...
    <div class="product-card">
      <img src="${contextPath}/resources/images/5.png" alt="Dell Inspiron 14 7445">
    ...
    <div class="product-card">
      <img src="${contextPath}/resources/images/6.png" alt="Dell G15 5500 Gaming">
  ...
  <section>
    <div class="carousel-container">
      ...
      <div class="carousel-track" id="carouselTrack">
        <img src="${contextPath}/resources/images/acer.png" alt="Logo 1" class="carousel-logo" />
        <img src="${contextPath}/resources/images/alienware.png" alt="Logo 2" class="carousel-logo" />
        <img src="${contextPath}/resources/images/apple.png" alt="Logo 3" class="carousel-logo" />
        <img src="${contextPath}/resources/images/asus.png" alt="Logo 4" class="carousel-logo" />
        <img src="${contextPath}/resources/images/canon.png" alt="Logo 5" class="carousel-logo" />
        <img src="${contextPath}/resources/images/dell.png" alt="Logo 6" class="carousel-logo" />
        <img src="${contextPath}/resources/images/epson.png" alt="Logo 7" class="carousel-logo" />
        <img src="${contextPath}/resources/images/hp.png" alt="Logo 8" class="carousel-logo" />
        <img src="${contextPath}/resources/images/Xiaomi.png" alt="Logo 9" class="carousel-logo" />
        <img src="${contextPath}/resources/images/oneplus.png" alt="Logo 10" class="carousel-logo" />
        <img src="${contextPath}/resources/images/samsung.png" alt="Logo 11" class="carousel-logo" />
        <img src="${contextPath}/resources/images/vivo.png" alt="Logo 12" class="carousel-logo" />
      </div>
  ...
  <section>
    ...
    <div class="newcontainer">
      ...
      <div class="column">
        <div class="items">
          <div class="image-container">
            <img src="${contextPath}/resources/images/samsungbuds.png" class="brand" />
        ...
        <div class="items">
          <div class="image-container">
            <img src="${contextPath}/resources/images/stablet.png" class="brand" />
          </div>
          <div class="details">
        ...
        <div class="items">
          <div class="image-container">
            <img src="${contextPath}/resources/images/swatch.png" class="brand" />
      ...
      <div class="column">
        <div class="items">
          <div class="image-container">
            <img src="${contextPath}/resources/images/airpod4.png" class="brand" />
          </div>
          <div class="details">
        ...
        <div class="items">
          <div class="image-container">
            <img src="${contextPath}/resources/images/iwatch.png" class="brand" />
            <div class="discount">12%</div>
          </div>
          <div class="details">
        ...
        <div class="items">
          <div class="image-container">
            <img src="${contextPath}/resources/images/iphone.png" class="brand" />
            <div class="new">New Arrival</div>
          </div>
          <div class="details">
  ...
  <div class="products">
    <div class="product-card">
      <img src="${contextPath}/resources/images/s25grey.jpg" alt="s25 ultra">
    ...
    <div class="product-card">
      <img src="${contextPath}/resources/images/phone.png" alt="Samsung S25 Plus">
    ...
    <div class="product-card">
      <img src="${contextPath}/resources/images/s25blue.jpg" alt="Samsung galaxy S25">
    ...
    <div class="product-card">
      <img src="${contextPath}/resources/images/s25b.png" alt="Samsung galaxy S25 Edge">
  ...
  <div class="products">
    <div class="product-card">
      <img src="${contextPath}/resources/images/16 promax.png" alt="16 pro max">
